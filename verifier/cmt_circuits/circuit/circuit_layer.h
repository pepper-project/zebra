...
public:
  ...
  void computeWirePredicates(
            mpz_t add_predr, mpz_t mul_predr, mpz_t sub_predr, mpz_t muxl_predr, mpz_t muxr_predr,
            const std::vector<bool> muxBits, const MPZVector& rand, int inputLayerSize,
